...
class _SaadNahsScreenState extends State<SaadNahsScreen> {
  ...
  void _check() {
    ...
    if (day == null || day < 1 || day > 31) {
      setState(() {
        _error = 'روز ماه شمسی را بین ۱ تا ۳۱ وارد کن.';
        _result = null;
      });
      return;
    }
    ...
    setState(() {
      _error = null;
      _result = saadNahsTable.firstWhere(
        (e) => e.day == day,
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('سعد و نحس ایام'),
      ),
      body: Stack(
        children: [
  ...
  Widget _buildInputForm() {
    return Column(
      ...
      children: [
        ...
        Text(
          'عدد روز ماه (بین ۱ تا ۳۱) را وارد کن',
          textAlign: TextAlign.center,
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: _check,
            child: const Text('بررسی وضعیت روز'),
          ),
        ),
      ],
    );
    ...
    return AnimatedOpacity(
      ...
      child: Column(
        ...
        children: [
          ...
          OutlinedButton(
            onPressed: _reset,
            child: const Text('بررسی روز دیگر'),
          ),
        ],
      ),
    );
